            ...
            <tbody>
              <tr>
                <td class="w-30">
                  <div class="d-flex px-2 py-1 align-items-center">
                    <div>
                    <?php echo $this->Html->image("icons/flags/US.png",['class'=>'Country flag'])?>
              ...
              <tr>
                <td class="w-30">
                  <div class="d-flex px-2 py-1 align-items-center">
                    <div>
                    <?php echo $this->Html->image("icons/flags/DE.png",['class'=>'Country flag'])?>
                    </div>
                    <div class="ms-4">
                      <p class="text-xs font-weight-bold mb-0 ">Country:</p>
              ...
              <tr>
                <td class="w-30">
                  <div class="d-flex px-2 py-1 align-items-center">
                    <div>
                    <?php echo $this->Html->image("icons/flags/GB.png")?>
              ...
              <tr>
                <td class="w-30">
                  <div class="d-flex px-2 py-1 align-items-center">
                    <div>
                    <?php echo $this->Html->image("icons/flags/BR.png")?>
                    </div>
                    <div class="ms-4">
                      <p class="text-xs font-weight-bold mb-0 ">Country:</p>
