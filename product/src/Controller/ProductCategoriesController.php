...
class ProductCategoriesController extends AppController
{
    ...
    public function userstatus($id=null,$status=null){
        ...
        foreach($productCategory->products as $product){
            $proarr[] =+ $product->status;
        }
        
        if(!in_array('1',$proarr)){
        ...
        return $this->redirect(['action'=>'index']);
            ...
            return $this->redirect(['action'=>'activeproducts',$id]);
        }
        ...
        public function activeproducts($id=null)
    {
        $this->viewBuilder()->setLayout(null);
...
public function inactive($id=null)
    {
            $product=$this->Products->find('all')->where(['category_id'=>$id])->all();
            //dd($product);
            ...
            return $this->redirect(['controller'=>'ProductCategories','action'=>'userstatus',$id,1]);
