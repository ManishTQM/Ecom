...
<div class="container">
    ...
    <div class="column-responsive column-80">
        ...
        <h3 style="text-align:center;"><b>My Profile</b></h3>
                <?= $this->Html->link(__('Back'), ['controller'=>'Products','action' => 'list'], ['class' => 'button float-left']) ?>
    <?= $this->Html->link(__('Edit'), ['controller'=>'Users','action' => 'edituser'], ['class' => 'button float-right']) ?>
